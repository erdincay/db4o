...
namespace Db4objects.Db4o.Internal
{
	...
	public class ClassMetadata : PersistentBase, IStoredClass
	{
		...
		{
			public _TraverseFieldCommand_1700(ByRef foundField, string fieldName, Db4objects.Db4o.Internal.ClassMetadata
				 fieldTypeFilter)
			{
		...
		private void UpdateStaticClass(Transaction trans, StaticClass sc)
		{
			...
			IEnumerator staticFields = Iterators.Map(StaticReflectFields(), new _IFunction4_1760
